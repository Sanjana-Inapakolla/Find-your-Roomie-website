...
<head>
    ...
    <style>
        ...
        .founders-section {
            margin-top: 2rem;
            padding-top: 1rem;
            border-top: 1px solid #D3D3D3; /* Light Gray Border */
        }
        ...
        .btn-close {
            ...
            height: 30px;
            font-size: 1.2rem;
            background-color: #E6D33D; /* Yellow */
            border: none;
            color: #FFFFFF; /* White */
            border-radius: 50%;
        }
...
<body>
    <!-- Close Button -->
    <button type="button" class="btn-close" aria-label="Close" onclick="window.location.href='home.html';">&times;</button>
