...
<style>
    body {
        ...
        height: 100vh;
        margin: 0;
        background-color:#008080; /* Light gray */
    }
    ...
    .reviews {
        background-color: #FFFBCC; /* Soft yellow for review section */
        padding: 15px;
        border-radius: 10px;
    }
    ...
    /* Star color based on ratings */
    .star.one, .star.two {
        color: #FF6F00; /* Orange for low ratings */
    }

    .star.three {
        color: #FFDD00; /* Yellow for medium ratings */
    }

    .star.four, .star.five {
        color: #008080; /* Teal for high ratings */
    }
    ...
    #submitbutton {
        ...
        border: none;
        border-radius: 5px;
        background-color: #008080; /* Teal for the button */
    ...
    .btn-close {
        ...
        height: 30px;
        font-size: 1.2rem;
        background-color: #FFDD00; /* Yellow close button */
        border: none;
        cursor: pointer;
        border-radius: 50%;
    }
