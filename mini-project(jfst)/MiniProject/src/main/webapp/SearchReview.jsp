...
<style>
    ...
    body {
        ...
        background-color:#008080; /* Light gray for the background */
        color: #333;
        margin: 0;
        padding: 0;
        display: flex;
    ...
    .matches-container h2 {
        font-size: 1.8rem;
        color: #f8bf02; /* Yellow for titles */
        text-align: center;
        margin-bottom: 1rem;
    }
    ...
    .matches-container h3 {
        font-size: 1.5rem;
        color: #008080; /* Teal for hostel name */
        text-align: center;
        margin-bottom: 1rem;
    }
    ...
    .match-item {
        background-color: #ffdfba; /* Light orange for review items */
        border-radius: 6px;
        padding: 1rem;
        margin-bottom: 1rem;
        border-left: 4px solid #f39c12; /* Darker orange for the border */
        color: #495057;
        font-size: 1.1rem;
    ...
    .match-item:hover {
        ...
        background-color: #ffc04a; /* Slightly brighter orange on hover */
        border-left: 4px solid #007bff; /* Teal for the hover border */
    }
