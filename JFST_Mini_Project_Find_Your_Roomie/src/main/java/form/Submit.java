...
public class Submit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		User curUser = new User(email, name, gender, dob, phone, age, city, area, occupation, nativeplace, motherTongue,
				smoke, drink, diet);
		...
		if (isSubmitted) {
			...
			response.getWriter().write(
					"<img src='images/submitted.png' alt='success image' style='width:150px; height:150px; margin-top: 20px;'>");
			response.getWriter().write("<p>Thank you for submitting your information.</p>");
			response.getWriter()
					.write("<script>setTimeout(function() { window.location.href = 'home.html'; }, 2000);</script>");
			...
			response.getWriter()
					.write("<script>setTimeout(function() { window.location.href = 'form.html'; }, 2000);</script>");
			response.getWriter().write("</div></body></html>");
		}
